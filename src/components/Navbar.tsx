...
const Navbar = () => {
  ...
  const { openCourseSelection } = useEnrollment();
  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "glassmorphism shadow-sm py-3" : "bg-transparent"
      )}>
      <div className="section-container">
        <nav className="flex items-center justify-between">
          <div className="flex items-center">
            <a
              href="#"
              className="text-2xl font-display font-bold text-kaliber-950 flex items-center gap-2">
              <img src="/logo.png" alt="The Kaliber Logo" className="h-10 w-auto" />
            </a>
          </div>
