...
export const EnrollmentProvider = ({ children }: EnrollmentProviderProps) => {
  ...
  const openForm = (courseName: string) => {
    ...
    setIsFormOpen(true);
    setIsCourseSelectionOpen(false); // Close course selection when opening form
  };

  const openCourseSelection = () => {
    setIsCourseSelectionOpen(true);
  };
